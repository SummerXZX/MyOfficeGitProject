...
{
    [funpars appendFormat:@"<%@>%ld</%@>",name,(long)value,name];
}
...
-(NSArray *)getArrayResult
{
    ...
    GDataXMLDocument* _GDataParse = [[GDataXMLDocument alloc]initWithData:data  options:0 error:nil];
