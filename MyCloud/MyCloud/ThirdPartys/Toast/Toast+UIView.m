...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        CGSize expectedSizeTitle = [title getSizeWithFont:titleLabel.font Width:maxSizeTitle.width];
    ...
    if (message != nil) {
        ...
        CGSize expectedSizeMessage = [message getSizeWithFont:messageLabel.font Width:maxSizeMessage.width];
