...
/**
 Asks the data source for a size for button. Default is {100,35}
 
 @param scrollView scrollView A scrollView subclass object informing the delegate.
 @return The size for button
 */
- (CGSize)buttonSizeForEmptyDataSet:(UIScrollView *)scrollView;

/**
 Asks the data source for a CornerRadius for button. Default is 5.0
 
 @param scrollView scrollView A scrollView subclass object informing the delegate.
 @return The CornerRadius for button
 */
- (CGFloat)buttonCornerRadiusForEmptyDataSet:(UIScrollView *)scrollView;

/**
 Asks the data source for a buttonBorderWidth for button. Default is 0.0
 
 @param scrollView scrollView A scrollView subclass object informing the delegate.
 @return The buttonBorderWidth for button
 */
- (CGFloat)buttonBorderWidthForEmptyDataSet:(UIScrollView *)scrollView;

/**
 Asks the data source for a buttonBorderColor for button. Default is [UIColor clearColor]
 
 @param scrollView scrollView A scrollView subclass object informing the delegate.
 @return The buttonBorderColor for button
 */
- (UIColor *)buttonBorderColorForEmptyDataSet:(UIScrollView *)scrollView;

/**
 Asks the data source for a buttonBackgroundColor for button. Default is [UIColor clearColor]
 
 @param scrollView scrollView A scrollView subclass object informing the delegate.
 @return The buttonBackgroundColor for button
 */
